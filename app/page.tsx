...
export default function Home() {
  return (
    <>
      <HeaderComponent />
      <main className="relative flex flex-col  justify-center flex-grow p-4 md:pt-1 md:pb-3  min-w-full h-full overflow-x-hidden">
        <div className="flex flex-row items-center justify-center w-full">
          ...
          <p className="pl-2 text-sm font-medium">
            <span className="text-[#2f8935]">Support: </span>+1 5103505206
          </p>
        </div>
